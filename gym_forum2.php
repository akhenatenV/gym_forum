        ...
        <div class="main-section-- d-flex">
            ...
            <main class="forum-questions-wrapper-- d-flex w-100 flex-column gap-lg">
                ...
                <div class="forum-questions-content-- d-flex border-b-1 pad-b-xl">
                    ...
                    <div class="forum-questions-body-- d-flex flex-column mar-l-xxl w-100">
                        ...
                        <div class="forum-question-body-content-- d-flex gap-lg">
                            <div class="btn-group">
                                <spoan class="badge">html</spoan>
                                <spoan class="badge">Javascript</spoan>
                                <spoan class="badge">style sheets / css</spoan>
                            </div>
                ...
                <div class="forum-questions-content-- d-flex border-b-1 pad-b-xl">
                    ...
                    <div class="forum-questions-body-- d-flex flex-column mar-l-xxl w-100">
                        <h5 class="forum-question-body-title-- mar-b-sm"><a href="">This is the title of the question and this ia a little loger to see what happens</a></h5>
                        <div class="forum-question-body-content-- d-flex gap-lg">
                            <div class="btn-group">
